							...
							<div class="tab-content pt-0">
								...
								<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
											...
											<li>
												<div class="comment" style="padding-left: 15px">
													...
													<div class="comment-body">
														<div class="meta-data">
															<span class="comment-author" style="padding-right: 880px">{{$review->patient->first_name}} {{$review->patient->last_name}}</span>
									...
									<div class="write-review">
										<h4>Write a review for <strong>Dr. {{$doctor->first_name}} {{$doctor->last_name}}</strong></h4>
										
										<!-- Write Review Form -->
										<form action="{{route('review',[$doctor->id])	}}" method="POST">
											@csrf
											...
											<div class="form-group">
												...
												<textarea id="review_desc" maxlength="100" name="comment" class="form-control"></textarea>

                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-stethoscope"></i></span></div>
                                            <select class="custom-select form-control" id="usertype" name="usertype" disabled>
                                ...
                                <div class="form-group"  id="userDiv">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user-md"></i></span></div>
                                            <select class="custom-select form-control" id="user" name="user_id" >
                                                <option values='{{auth()->user()->id}}'>{{auth()->user()->first_name}} {{auth()->user()->last_name}}</option>
                                            </select>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function () {
            ...
            if (books.val() === '') {
                ...
                $.ajax({
                    url: "{{route('get-user-by-user-type')}}?usertype=" + $('#usertype').val(),
                    method: 'GET',

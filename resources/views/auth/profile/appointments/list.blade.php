                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="/profile/d/Appointments/Create/{{auth()->user()->id}}" class="btn btn-brand btn-elevate btn-icon-sm">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable  kt_table_1">
                                ...
                                @foreach($appointments as $appointment)
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="/profile/Appointments/details/{{$appointment->id}}/{{$appointment->patient->id}}/{{$appointment->doctor->id}}" class="dropdown-item"><i

        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Prescriptions List</h3>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{route('prescriptions.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="/profile/Prescriptions/details/{{$prescription->id}}/{{$prescription->patient->id}}/{{$prescription->doctor->id}}" class="dropdown-item"><i

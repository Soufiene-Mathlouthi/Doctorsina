                                ...
                                <div class="kt-widget__head">
                                    <div class="kt-widget__media">
                                        @if(strpos($doctor->picture,'doctors_pictures')!==false)
                                            <img src="{{asset('uploads/doctors_pictures/'.$doctor->picture)}}" class="img-circle kt-widget__img">
                                        @else
                                            <img src="{{asset('uploads/doctors_pictures/'.$doctor->picture)}}" class="rounded kt-widget__img">
                                        @endif
...
<hr>
                                ...
                                <div class="kt-widget__footer">
                                    <a href="{{ url('') }}/profile/edit/{{$doctor->id}}" class="btn btn-label-success btn-lg btn-upper">EDIT</a>
                                </div>
                            </div>
                            <!--end::Widget -->

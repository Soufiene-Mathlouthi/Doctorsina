        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">{{isset($document) ? 'Edit Document Info' : 'Add Document'}}</h3>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    {{isset($document) ? 'Edit Document Info' : 'Add Document'}}
                                </h3>
                            </div>
                        </div>
                        ...
                        <form class="kt-form kt-form--label-right"
                                        ...
                                        @if(isset($patients))
                                            <select class="form-control" name="patient" id="patient">
                                                ...
                                                @foreach($patients as $patient)
                                                    <option
                                                        value="{{$patient->id}}" @if(isset($document)) {{$patient->id == $document->patient_id ? 'selected' : ''}} @endif>{{$patient->first_name.''.$patient->last_name}}</option>
                                                @endforeach
                                            </select>
                                        @endif
                                        @endif
                                        ...
                                        @if(isset($doctors))
                                            <select class="form-control" name="doctor" id="doctor">
                                                ...
                                                @foreach($doctors as $doctor)
                                                    <option
                                                        value="{{$doctor->id}}" @if(isset($document)) {{$doctor->id == $document->doctor_id ? 'selected' : ''}} @endif>{{$doctor->first_name.''.$doctor->last_name}}</option>
                                                @endforeach
                                            </select>
                                        @endif
                                        @endif
                                ...
                                <div class="form-group" id="dateDiv">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="date" id="date"
                                               @if(isset($document)) value="{{$document->date}}"@endif>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="description"
                                                  id="description">@if(isset($document)) {{$document->description}} @endif</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option
                                                value="active" @if(isset($document)) {{$document->status == 'active' ? 'selected' : ''}} @endif>
                                                active
                                            </option>
                                            <option
                                                value="inactive" @if(isset($document)) {{$document->status == 'inactive' ? 'selected' : ''}} @endif>
                                                inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="file" class="form-control" name="doc" id="doc"
                                               @if(isset($document)) value="{{$document->file}}" @endif
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <input type="submit" value="{{isset($document) ? 'Update' : 'Submit'}}"

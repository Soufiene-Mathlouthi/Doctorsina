        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Documents List</h3>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="/profile/Documents/create/d" class="btn btn-brand btn-elevate btn-icon-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="/profile/Documents/details/{{$document->id}}/{{$document->patient->id}}/{{$document->doctor->id}}" class="dropdown-item"><i
